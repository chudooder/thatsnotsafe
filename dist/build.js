...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _characters = __webpack_require__(33);
	...
	var _tests = __webpack_require__(51);
	...
	// helper functions
	var trimActions = function trimActions(arr) {
	    for (var p = 0; p <= 1; p++) {
	...
	var store = new _vuex2.default.Store({
	    ...
	    mutations: {
	        calculateFrameData: function calculateFrameData(state) {
	            state.frameData = _rules2.default.calculateFrames(state.characters, state.actions);
	        },
	        ...
	        selectMove: function selectMove(state, payload) {
	            state.selectedMove = payload;
	        },

	        deselectMove: function deselectMove(state) {
	            state.selectedMove = null;
	        },

	        setCharacter: function setCharacter(state, payload) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/App.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FrameColumn = __webpack_require__(21);

	var _FrameColumn2 = _interopRequireDefault(_FrameColumn);
	...
	exports.default = {
	    components: { FrameColumn: _FrameColumn2.default, Sidebar: _Sidebar2.default },
	    ...
	    computed: (0, _vuex.mapState)(['characters', 'frameData']),

	    methods: {
	        getCharacterList: function getCharacterList() {
	            return (0, _keys2.default)(_characters2.default.data);
	        },

	        getCharacterMoves: function getCharacterMoves(player) {
	            var charName = this.characters[player];
	            return _characters2.default.data[charName].moves;
	        },

	        getUniversalActions: function getUniversalActions() {
	            return _characters2.default.universalActions;
	        }
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/FrameColumn.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _FrameIndicator = __webpack_require__(23);

	var _FrameIndicator2 = _interopRequireDefault(_FrameIndicator);

	var _ActionIndicator = __webpack_require__(36);

	var _ActionIndicator2 = _interopRequireDefault(_ActionIndicator);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = {
	    components: { FrameIndicator: _FrameIndicator2.default, ActionIndicator: _ActionIndicator2.default },

	    props: {
	        frame: Number
	    },

	    computed: (0, _vuex.mapState)(['actions', 'characters', 'frameData'])
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/FrameIndicator.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _velocityAnimate = __webpack_require__(34);
	...
	exports.default = {
	    ...
	    methods: {
	        toColor: function toColor(frameType) {
	            switch (frameType) {
	                case _rules2.default.FrameType.NEUTRAL:
	                    return "#ffffff";
	                case _rules2.default.FrameType.ATTACK_STARTUP:
	                    return "#ffd70f";
	                case _rules2.default.FrameType.ATTACK_ACTIVE:
	                    return "#ff6a00";
	                case _rules2.default.FrameType.ATTACK_ACTIVE_NO_HITBOX:
	                    return "#ffb86d";
	                case _rules2.default.FrameType.ATTACK_RECOVERY:
	                    return "#9b044b";
	                case _rules2.default.FrameType.HITSTUN:
	                    return "#ff1c1c";
	                case _rules2.default.FrameType.BLOCKSTUN:
	                    return "#275fea";
	                case _rules2.default.FrameType.JUMPSQUAT:
	                    return "#333333";
	                case _rules2.default.FrameType.LANDING_RECOVERY:
	                    return "#9b044b";
	            }
	        },

	        toString: function toString(frameType) {
	            switch (frameType) {
	                case _rules2.default.FrameType.NEUTRAL:
	                    return "Neutral";
	                case _rules2.default.FrameType.ATTACK_STARTUP:
	        ...
	        getTooltipStyle: function getTooltipStyle(top) {
	            if (top) {
	                return { top: "120%" };
	            } else {
	                return { bottom: "120%" };
	    ...
	    watch: {
	        color: function color(newColor) {
	            (0, _velocityAnimate2.default)(this.$el, { backgroundColor: newColor }, { duration: 500 });
	        }
	    }
	    // </script>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function canAct(state) {
	    return state.type === PlayerState.NEUTRAL || state.type === PlayerState.CROUCHING || isBlocking(state) && state.blockstun === 0;
	}
	...
	function isActiveFrames(frameType) {
	    return frameType === FrameType.ATTACK_ACTIVE || frameType === FrameType.ATTACK_ACTIVE_NO_HITBOX;
	}
	...
	function canAttack(frame, state, newMove) {
	    ...
	    state.type === PlayerState.ATTACKING && state.connected && !isStartupFrames(getAttackFrameType(state.move, frame - state.startFrame + 1)) && _characters2.default.attackCancelAllowed(state.move, newMove);
	}

	function canJump(frame, state) {
	    return canAct(state) ||
	    // can jump if attacking with JC-able move
	    state.type === PlayerState.ATTACKING && state.connected && isActiveFrames(getAttackFrameType(state.move, frame - state.startFrame + 1)) && _characters2.default.jumpCancelAllowed(state.move);
	}

	function isBlocking(state) {
	    return state.type === PlayerState.BLOCKING || state.type === PlayerState.CROUCH_BLOCKING || state.type === PlayerState.INSTANT_BLOCKING || state.type === PlayerState.CROUCH_INSTANT_BLOCKING || state.type === PlayerState.FAULTLESS_DEFENSE || state.type === PlayerState.CROUCH_FAULTLESS_DEFENSE;
	}

	function isInstantBlocking(state) {
	    return state.type === PlayerState.INSTANT_BLOCKING || state.type === PlayerState.CROUCH_INSTANT_BLOCKING;
	}

	function isFaultlessBlocking(state) {
	    return state.type === PlayerState.FAULTLESS_DEFENSE || state.type === PlayerState.CROUCH_FAULTLESS_DEFENSE;
	}

	function isCrouching(state) {
	    return state.type === PlayerState.CROUCHING || state.type === PlayerState.CROUCH_BLOCKING || state.type === PlayerState.CROUCH_INSTANT_BLOCKING;
	}

	function blocksMove(state, move) {
	    return isBlocking(state) && (!isCrouching(state) && move.guard != "Low" || isCrouching(state) && !move.guard.startsWith('High'));
	}
	...
	function processInitialStateChangingActions(frame, actions, states, characters) {
	    for (var player = 0; player <= 1; player++) {
	        ...
	        if (!action) {
	            ...
	            states[player].jumpsquat = _characters2.default.data[characters[player]].jumpStartup;

	            // all other actions treated as attacks
	        } else if (!action.startsWith("_")) {
	            var newMove = _characters2.default.data[characters[player]].moves[action];
	...
	function processStateInteraction(frame, states, frames, characters) {
	    var newStates = [(0, _assign2.default)({}, states[0]), (0, _assign2.default)({}, states[1])];
	    for (var player = 0; player <= 1; player++) {
	        var other = 1 - player;
	        ...
	        if (states[player].type == PlayerState.ATTACKING) {
	            ...
	            if (frameType == FrameType.ATTACK_ACTIVE && (!isBlocking(states[other]) || !blocksMove(states[other], move)) && !states[player].connected) {

	                newStates[player].connected = true;
	                var hitstunAmt = _characters2.default.hitstun(move.level, isCrouching(states[other]));
	                // cornercase: if already in hitstun, we need to add +1 frame because
	                // we decrement one too many times
	                if (states[other].hitstun > 0) hitstunAmt++;
	            ...
	            else if (frameType == FrameType.ATTACK_ACTIVE && isBlocking(states[other], move) && !states[player].connected) {

	                    newStates[player].connected = true;
	                    var blockstunAmt = _characters2.default.blockstun(move.level, isInstantBlocking(states[other]), isFaultlessBlocking(states[other]));
	                    // cornercase: if already blocking, we need to add +1 frame because
	                    // we decrement one too many times
	                    if (states[other].blockstun > 0) blockstunAmt++;
	...
	function calculateFrames(characters, actions) {
	    var states = [{ type: PlayerState.NEUTRAL, airborne: false }, { type: PlayerState.NEUTRAL, airborne: false }];
	    var frames = [[], []];
	    var curFrame = 0;
	    var done = false;
	    ...
	    while (!done) {
	        ...
	        if (actions[0][curFrame] === undefined && actions[1][curFrame] === undefined && canAct(states[0]) && canAct(states[1])) {
...
/***/ (function(module, exports) {
	...
	var Characters = function () {
	        ...
	        "Elphelt": {
	            ...
	            "moves": {
	                "5P": {
	                    ...
	                    "total_active": 3,
	                    "recovery": 5,
	                    "gatling": ["5P", "2P", "6P", "5K", "2K", "c.S", "f.S", "2S", "5H", "2H", "6H", "5D", "2D"]
	                },
	                "5K": {
	                    "key": "5K",
	                    "type": "normal",
	                    ...
	                    "total_active": 4,
	                    "recovery": 5,
	                    "gatling": ["c.S", "f.S", "2S", "2H", "6H", "5D", "2D"]
	                },
	                "c.S": {
	                    "key": "c.S",
	                    "type": "normal",
	                ...
	                "2P": {
	                    ...
	                    "total_active": 2,
	                    "recovery": 7,
	                    "gatling": ["5P", "2P", "6P", "5K", "2K", "c.S", "f.S", "2S", "2H", "5D", "2D"]
	                },
	                "2K": {
	                    "key": "2K",
	                    "type": "normal",
	        ...
	        "Chipp": {
	            ...
	            "moves": {
	                ...
	                "5K": {
	                    ...
	                    "total_active": 5,
	                    "recovery": 8,
	                    "gatling": ["5P", "5K", "2K", "c.S", "f.S", "2S", "5H", "2H", "5D", "2D"]
	                },
	                "c.S": {
	                    "key": "c.S",
	                    "hits": 1,
	                    ...
	                    "total_active": 2,
	                    "recovery": 10,
	                    "gatling": ["6P", "6K", "f.S", "2S", "5H", "2H", "5D", "2D"]
	                },
	                "f.S": {
	                    "key": "f.S",
	                    "hits": 1,
	                ...
	                "2P": {
	                    ...
	                    "total_active": 2,
	                    "recovery": 7,
	                    "gatling": ["5P", "2P", "6P", "5K", "2K", "c.S", "f.S", "2S", "5H", "2H", "5D", "2D"]
	                },
	                "2K": {
	                    "key": "2K",
	                    "hits": 1,
	                    ...
	                    "total_active": 4,
	                    "recovery": 7,
	                    "gatling": ["5P", "2P", "6P", "2K", "5K", "c.S", "f.S", "2S", "5H", "2H", "6H", "5D", "2D"]
	                },
	                "2S": {
	                    "key": "2S",
	                    "hits": 1,
	                ...
	                "6P": {
	                    ...
	                    "total_active": 3,
	                    "recovery": 25,
	                    "gatling": ["c.S", "f.S", "2S", "5H", "2H", "6H", "5D", "2D"]
	                },
	                "6K": {
	                    "key": "6K",
	                    "hits": 1,
	    ...
	    [10, 10, 10, 9, 7, 11, 9, 3, 11], [12, 13, 12, 11, 8, 13, 11, 5, 14], [14, 15, 14, 13, 10, 15, 13, 7, 17], [17, 18, 16, 16, 12, 18, 16, 9, 20], [19, 20, 18, 18, 14, 20, 19, 11, 23]];
	    ...
	    function attackCancelAllowed(curMove, newMove) {
	        console.log(curMove);
	        return curMove.gatling.indexOf(newMove.key) != -1 || newMove.type === 'special' && curMove.cancel.indexOf('S') != -1;
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/ActionIndicator.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    computed: (0, _vuex.mapState)(['selectedMove', 'characters']),
	    ...
	    methods: {
	        ...
	        backgroundColor: function backgroundColor() {
	            if (!this.action) {
	                ...
	                if (this.hovering) return "#d51";else return "#5d1";
	            }
	        },
	        ...
	        canApply: function canApply(movePayload) {
	            return !movePayload.character || movePayload.character === this.characters[this.player];
	        }
	    }
	    // </script>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/Sidebar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SidebarSection = __webpack_require__(42);
	...
	// <script>
	exports.default = {
	    components: { SidebarSection: _SidebarSection2.default },
	    props: {
	        characters: Array
	    },
	    methods: {
	        ...
	        getMoves: function getMoves(charName) {
	            return _characters2.default.data[charName].moves;
	        }
	    }
	    // </script>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/SidebarSection.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SidebarRow = __webpack_require__(44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/shawn/workspace/thatsnotsafe/src/components/SidebarRow.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = "\n    <div>\n        <div\n            class=\"sidebar-header\"\n            @click=\"hidden = !hidden\">\n            <div class=\"sidebar-header-container\" style=\"display:inline-block\"> {{ sectionName }} </div>\n            <div class=\"sidebar-header-container\" style=\"float:right\">\n                <img :style=getArrowStyle() src=\"" + __webpack_require__(48) + "\">\n            </div>\n        </div>\n        <div v-if=\"!hidden\">\n            <SidebarRow\n                v-if=\"actions\"\n                v-for=\"(action, name, index) in actions\"\n                :key=\"name\"\n                :action=\"action\"\n                :name=\"name\"\n                :index=\"index\"></SidebarRow>\n            <SidebarRow\n                v-if=\"moves\"\n                v-for=\"(move, name, index) in moves\"\n                :key=\"name\"\n                :move=\"move\"\n                :name=\"name\"\n                :index=\"index\"\n                :character=\"character\"></SidebarRow>\n        </div>\n    </div>\n";

/***/ }),
/* 48 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "f182a8b3792ebad660895fdd32b68a13.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Tests = function () {
	    ...
	    var FrameType = _rules2.default.FrameType;
	    ...
	    function runTests() {
	        test("basic-hitstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P"], []]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 4]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 10], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("basic-crouch-hitstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["c.S"], ["_C"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 5], [FrameType.ATTACK_RECOVERY, 18], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 18], [FrameType.NEUTRAL, 5]]), res[1]);
	        });

	        test("basic-blockstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P"], ["_SB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 3]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.BLOCKSTUN, 9], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("instant-blockstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P"], ["_IB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.BLOCKSTUN, 7], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("crouch-instant-blockstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P"], ["_CIB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.BLOCKSTUN, 7], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("faultless-blockstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P"], ["_FD"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 5]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.BLOCKSTUN, 11], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("crouch-faultless-blockstun", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P"], ["_CFD"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 5]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.BLOCKSTUN, 11], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("gatling-success", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P", null, null, null, null, "5K"], []]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 1], [FrameType.ATTACK_STARTUP, 6], [FrameType.ATTACK_ACTIVE, 4], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 3]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 17], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("gatling-fail-startup", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5P", null, "5K"], []]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 5], [FrameType.NEUTRAL, 4]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 10], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("gatling-fail-no-route", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["c.S", null, null, null, null, "5K"], ["_C"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 5], [FrameType.ATTACK_RECOVERY, 18], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 18], [FrameType.NEUTRAL, 5]]), res[1]);
	        });

	        test("basic-multihit", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["2H"], []]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 17], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_ACTIVE_NO_HITBOX, 3], [FrameType.ATTACK_ACTIVE, 3], [FrameType.ATTACK_RECOVERY, 18], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 18], [FrameType.HITSTUN, 23], [FrameType.NEUTRAL, 4]]), res[1]);
	        });

	        test("special-cancel-success", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["2P", null, null, null, "236P"], []]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 3], [FrameType.ATTACK_ACTIVE, 1], [FrameType.ATTACK_RECOVERY, 18], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 4], [FrameType.HITSTUN, 10], [FrameType.NEUTRAL, 9]]), res[1]);
	        });

	        test("high-block-low-hit", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["2K"], ["_SB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 5], [FrameType.ATTACK_RECOVERY, 6], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 10], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("low-block-high-hit", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5D"], ["_CB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 23], [FrameType.ATTACK_ACTIVE, 6], [FrameType.ATTACK_RECOVERY, 16], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 24], [FrameType.HITSTUN, 15], [FrameType.NEUTRAL, 7]]), res[1]);
	        });

	        test("can-switch-block-low-high", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["2K"], ["_CB", "_SB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 5], [FrameType.ATTACK_RECOVERY, 6], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 10], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("can-switch-block-high-low", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["5D"], ["_SB", "_CB"]]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 23], [FrameType.ATTACK_ACTIVE, 6], [FrameType.ATTACK_RECOVERY, 16], [FrameType.NEUTRAL, 1]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 24], [FrameType.HITSTUN, 15], [FrameType.NEUTRAL, 7]]), res[1]);
	        });

	        test("jump-cancel", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["c.S", null, null, null, null, "_J"], []]);
	            assertArrays(expand([[FrameType.ATTACK_STARTUP, 4], [FrameType.ATTACK_ACTIVE, 1], [FrameType.JUMPSQUAT, 3], [FrameType.NEUTRAL, 15]]), res[0]);
	            assertArrays(expand([[FrameType.NEUTRAL, 5], [FrameType.HITSTUN, 17], [FrameType.NEUTRAL, 1]]), res[1]);
	        });

	        test("landing-recovery", function () {
	            var res = _rules2.default.calculateFrames(["Elphelt", "Elphelt"], [["_J", null, null, "j.D", null, "_L"], []]);
	            assertArrays(expand([[FrameType.JUMPSQUAT, 3], [FrameType.ATTACK_STARTUP, 3], [FrameType.LANDING_RECOVERY, 5], [FrameType.NEUTRAL, 1]]), res[0]);
	        });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".column-slide-enter, .column-slide-leave-to {\n    opacity: 0;\n    transform: translateY(-10px);\n}\n\n.column-slide-enter-active, .column-slide-leave-active {\n    transition: all 0.5s ease;\n}", ""]);
